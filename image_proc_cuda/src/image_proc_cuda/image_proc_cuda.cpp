...
ImageProcCuda::ImageProcCuda(bool use_gpu) : use_gpu_(use_gpu) {
  // Load parameters
...
ImageProcCuda::ImageProcCuda(bool use_gpu, const std::string& params_path, const std::string& calibration_path,
