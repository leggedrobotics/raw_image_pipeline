...
WhiteBalanceModule::WhiteBalanceModule(bool use_gpu) : enabled_(true), use_gpu_(use_gpu), method_("ccc") {
  ccc_ = std::make_unique<raw_image_pipeline_white_balance::ConvolutionalColorConstancyWB>(use_gpu);
}
